...
const BusinessCard = ({ business }: { business: BusinessDto }) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <Button
            ...
            className="h-12 w-full sm:w-40 md:w-52 border border-[#E2E2E2] rounded-lg text-[#1F1F1F]"
          />
          <Button
            text={t('businesses.holdBusiness')}
            className="h-12 w-full sm:w-40 md:w-52 border border-[#FFA500] rounded-lg text-[#FFA500] flex items-center justify-center gap-2"
            icon={<Pause className="w-4 h-4 text-[#FFA500]" />}
          />
          <Button
            text={t('businesses.delete')}
            className="h-12 w-full sm:w-40 md:w-52 border border-[#FF0B0B] rounded-lg text-[#FF0B0B]"
          />
        </div>
      </div>
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="space-y-2">
          <span className="text-[#717680] text-xs">{t('businesses.storeCrNumber')}</span>
        ...
        <div className="space-y-2">
          <span className="text-[#717680] text-xs">{t('businesses.storeType')}</span>
          <h3 className="text-base font-semibold text-[#414651]">
            {business.activity}
          </h3>
        </div>
        <div className="space-y-2">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold text-[#414651]">$10,550,35</h3>
          <span className="text-[#717680] text-xs">{t('businesses.activeCustomerDebts')}</span>
        </div>
        <div className="space-y-2">
          <span className="text-[#717680] text-sm flex items-center gap-2">
        ...
        <div className="space-y-2">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold text-[#414651]">$10,550,35</h3>
          <span className="text-[#717680] text-xs">{t('businesses.customersOverdue', { count: 3 })}</span>
        </div>
      </div>
    </div>
  );
