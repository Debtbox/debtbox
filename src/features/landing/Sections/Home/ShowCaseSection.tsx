  ...
  return (
    <section className="features-section showcase-section landing-section" aria-label={t('showcase.ariaLabel', 'Features showcase')}>
      ...
      <div className="phone-image">
        <img src={phone} alt="Phone Mockup" className={isRtl ? 'rtl-phone' : 'ltr-phone'} loading="lazy" decoding="async" width={320} height={640} />
      </div>

      <div className="feature-card top-right">
        <img src={redIcon} alt="Icon" className="card-icon" loading="lazy" decoding="async" />
